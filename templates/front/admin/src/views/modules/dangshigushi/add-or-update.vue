<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="党史编号" prop="dangshibianhao">
            <el-input v-model="ruleForm.dangshibianhao" 
                placeholder="党史编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dangshibianhao" label="党史编号" prop="dangshibianhao">
              <el-input v-model="ruleForm.dangshibianhao" 
                placeholder="党史编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="党史分类" prop="dangshifenlei">
          <el-select :disabled="ro.dangshifenlei" v-model="ruleForm.dangshifenlei" placeholder="请选择党史分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="党史分类" prop="dangshifenlei">
	      <el-input v-model="ruleForm.dangshifenlei"
                placeholder="党史分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="党史介绍" prop="dangshijieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="党史介绍"
                  v-model="ruleForm.dangshijieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dangshijieshao" label="党史介绍" prop="dangshijieshao">
                    <span>{{ruleForm.dangshijieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="历史故事" prop="lishigushi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="历史故事"
                  v-model="ruleForm.lishigushi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.lishigushi" label="历史故事" prop="lishigushi">
                    <span>{{ruleForm.lishigushi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	dangshibianhao : false,
	dangshifenlei : false,
	tupian : false,
	dangshijieshao : false,
	lishigushi : false,
	xiangqing : false,
      },
      ruleForm: {
        dangshibianhao: this.getUUID(),
        dangshifenlei: '',
        tupian: '',
        dangshijieshao: '',
        lishigushi: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='dangshibianhao'){
            this.ruleForm.dangshibianhao = obj[o];
	    this.ro.dangshibianhao = true;
            continue;
          }
          if(o=='dangshifenlei'){
            this.ruleForm.dangshifenlei = obj[o];
	    this.ro.dangshifenlei = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='dangshijieshao'){
            this.ruleForm.dangshijieshao = obj[o];
	    this.ro.dangshijieshao = true;
            continue;
          }
          if(o=='lishigushi'){
            this.ruleForm.lishigushi = obj[o];
	    this.ro.lishigushi = true;
            continue;
          }
          if(o=='xiangqing'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../django4xa3d/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dangshigushi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dangshigushiCrossAddOrUpdateFlag = false;
						 this.parent.search();
