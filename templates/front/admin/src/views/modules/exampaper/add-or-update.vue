<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="开心一下名称" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="开心一下名称" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="开心一下名称" prop="name">
              <el-input v-model="ruleForm.name" 
                placeholder="开心一下名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="开心一下状态" prop="status">
          <el-select :disabled="ro.status" v-model="ruleForm.status" placeholder="请选择开心一下状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="开心一下状态" prop="status">
              <el-input v-model="ruleForm.status?'启用':'禁用'" 
                placeholder="开心一下状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	status : false,
      ...
      rules: {
          name: [
                { required: true, message: '开心一下名称不能为空', trigger: 'blur' },
          ],
          time: [
          ...
          status: [
                { required: true, message: '开心一下状态不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
      }
    };
