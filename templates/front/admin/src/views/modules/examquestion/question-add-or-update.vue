<template>
  <div>
    <el-form
      ...
      label-width="80px"
    >
      <el-form-item label="选择开心一下" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择开心一下">
          <el-option
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择开心一下", trigger: "blur" }],
        questionname: [
