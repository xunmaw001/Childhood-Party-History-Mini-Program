<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="链接" prop="lianjie">
          <el-input v-model="ruleForm.lianjie" 
              placeholder="链接" clearable  :readonly="ro.lianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="链接" prop="lianjie">
              <el-input v-model="ruleForm.lianjie" 
                placeholder="链接" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shishiredian/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shishiredianCrossAddOrUpdateFlag = false;
						 this.parent.search();
