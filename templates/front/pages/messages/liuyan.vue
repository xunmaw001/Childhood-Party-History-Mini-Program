	...
	<view class="content my-publish-pv">
		<form>
			...
			<view class="cu-form-group" style="text-align:center">
				<button :style='{"padding":"0 20rpx","boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","margin":"20rpx auto","borderColor":"#409EFF","backgroundColor":"rgba(206, 34, 27, 1)","color":"#fff","borderRadius":"60rpx","borderWidth":"0","width":"60%","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' @tap="onSubmitTap" class="bg-red margin-tb-sm">提交</button>
			</view>
		</form>
	</view>
</template>
...
<style lang="scss" scoped>
	...
	.content:after {
		...
		bottom: 0;
		content: '';
				background-image: url(http://codegen.caihongy.cn/20220226/9b4ccc689fd44520be95b411e13390cb.png);
