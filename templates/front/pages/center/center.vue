<template>
	<view class="content">
		...
		<view class="list" :style='{"padding":"0 24rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"24rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
			...
			<view @tap="onPageTap('../messages/list')" :style='{"padding":"16rpx 0 8rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"12rpx auto","backgroundColor":"#fff","borderColor":"#ccc","borderRadius":"30rpx","borderWidth":"0","width":"30%","borderStyle":"solid","height":"auto"}' class="li" hover-class="hover">
				<view v-if="true" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"#fff","color":"rgba(254, 202, 0, 1)","isShow":true,"borderRadius":"0","borderWidth":"0","width":"auto","lineHeight":"64rpx","fontSize":"64rpx","borderStyle":"solid"}' class="cuIcon-message"></view>
				<view class="text" :style='{"padding":"0 20rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(161, 161, 161, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'>留言反馈</view>
